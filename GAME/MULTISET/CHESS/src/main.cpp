...
Bool Open()
{
	...
	DrawClear();
	DrawText2("Chess", (WIDTH - 5*16)/2, 0, COL_YELLOW);

#define MENUX 30
#define MENUY	40
#define MENUDY	16

	DrawText("Select:", MENUX+16, MENUY+0*MENUDY, COL_GREEN);
	DrawText("LEFT .... Play with white", MENUX, MENUY+1*MENUDY, COL_WHITE);
	DrawText("RIGHT ... Play with black", MENUX, MENUY+2*MENUDY, COL_WHITE);
	DrawText("DOWN .... Play 2 players", MENUX, MENUY+3*MENUDY, COL_WHITE);
	DrawText("UP ...... Demo", MENUX, MENUY+4*MENUDY, COL_WHITE);
	DrawText("A ....... Select level:", MENUX, MENUY+5*MENUDY, COL_WHITE);
	DrawText("Y ....... Quit to main menu", MENUX, MENUY+6*MENUDY, COL_WHITE);
...
#define MENUY2	(MENUY+7*MENUDY)
	...
	DrawText("A ....... Select piece", MENUX, MENUY2+2*MENUDY, COL_WHITE);
	...
	for (;;)
	{
		...
		if (DeepMax == 2)
			DrawTextBg("BEGINNER", MENUX+24*8, MENUY+5*MENUDY, COL_WHITE, COL_BLACK);
		else if (DeepMax == 3)
			DrawTextBg("ADVANCED", MENUX+24*8, MENUY+5*MENUDY, COL_WHITE, COL_BLACK);
		else if (DeepMax == 4)
			DrawTextBg("PRO     ", MENUX+24*8, MENUY+5*MENUDY, COL_WHITE, COL_BLACK);
		else
			DrawTextBg("SUPERPRO", MENUX+24*8, MENUY+5*MENUDY, COL_WHITE, COL_BLACK);
