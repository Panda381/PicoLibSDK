...
extern const u8 LandscapeImg[102400] __attribute__ ((aligned(4)));
...
extern const u8 ShadowsImg[6144] __attribute__ ((aligned(4)));
#define SHADOWW		32
#define SHADOWH		32
...
extern const u8 TilesImg[3328] __attribute__ ((aligned(4)));
#define TILEW	16
#define TILEH	16
