...
const char* const DamgaardCol1[] = {

	// 1 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#  # ...#!"
	"#  $$#..#!"
	"#  $  *.#!"
	...
	// 2 (Brian Damgaard: The YASGen Collection)
	"x########!"
	"##@$ .. #!"
	"# $#$ *.#!"
	"#  $  *.#!"
	...
	// 3 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#   . $ #!"
	"# $ ***@#!"
	"##   .$ #!"
	...
	// 4 (Brian Damgaard: The YASGen Collection)
	"x########!"
	"##      #!"
	"#@$ $*  #!"
	"##$$ * ##!"
	...
	// 5 (Brian Damgaard: The YASGen Collection)
	"xx#######!"
	"xx# . $@#!"
	"x## .$$##!"
	"x# $.$ ##!"
	...
	"#  $..  #!"
	"#########!",
	"lDLLddddLUdrrrruulDLdlluRllldRRuruuurrDDrddLULLuuurrdDrdLuuulldRurDDul"
	"lddLdlluRuuRRddLruulldRddlUruuruulDDurrrddrddlULLLdlluRRRUUluurDldDrdl"
	"uuurrrdDuullDurruLrdddrddlUUULulldddrRlluuurrdLulDrrrdrddlUllldlluRRRu"
	"urrDullllDRddlUruurrrdrddlULLLuurrrDrdLuuluurDDDulllddrUluuRlddddlluRd"
	"rUruUllDurrddldlluRuRlddrUluurrrruulDrdLrdrddlUUUddLLLdlUrrrruuluurDDd"
	"rdLl",

	// 6 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#  #....#!"
	"#   @#**#!"
	"# $$# ..#!"
	...
	// 7 (Brian Damgaard: The YASGen Collection)
	"xxx######!"
	"x### ...#!"
	"x# $ #+.#!"
	"x#  $$**#!"
	...
	// 8 (Brian Damgaard: The YASGen Collection)
	"#######!"
	"#.... #!"
	"#*.## ###!"
	"#.* #   #!"
	...
	// 9 (Brian Damgaard: The YASGen Collection)
	"xx########!"
	"xx# *    #!"
	"### *.$  #!"
	"#   **$  #!"
	...
	// 10 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#  ##   #!"
	"#. $@$  #!"
	"#.*.$# ##!"
	...
	// 11 (Brian Damgaard: The YASGen Collection)
	"xx#####!"
	"###@ .#!"
	"# $ #.#!"
	"#  $$ #!"
	...
	// 12 (Brian Damgaard: The YASGen Collection)
	"#######!"
	"#@.   #!"
	"#$$.$.#!"
	"#. *$.#!"
	...
	// 13 (Brian Damgaard: The YASGen Collection)
	"#######!"
	"#+$ ..#!"
	"#$$$$*#!"
	"#.    #!"
	...
	// 14 (Brian Damgaard: The YASGen Collection)
	"#######!"
	"#. $..#!"
	"#.$ $.#!"
	"# $ $ #!"
	...
	// 15 (Brian Damgaard: The YASGen Collection)
	"#######!"
	"# . + #!"
	"# #$*$##!"
	"# $. . #!"
	...
	// 16 (Brian Damgaard: The YASGen Collection)
	"########!"
	"# .  . #!"
	"#. $*$.#!"
	"# #  $ #!"
	...
	// 17 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#@$  . .#!"
	"#**$$ * #!"
	"# $...* #!"
	...
	// 18 (Brian Damgaard: The YASGen Collection)
	"########!"
	"# . # @#!"
	"#  $ $$#!"
	"#.*. $ #!"
	...
	// 19 (Brian Damgaard: The YASGen Collection)
	"x######!"
	"x# .  #!"
	"##$#. ###!"
	"#@* .   #!"
	...
	// 20 (Brian Damgaard: The YASGen Collection)
	"########!"
	"# . .$+#!"
	"#  $*$*#!"
	"# . #  #!"
	...
	// 21 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#. .*  #!"
	"# $ *  #!"
	"## .$ *#!"
	...
	// 22 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#@$  . #!"
	"#$$** .#!"
	"#.   $ #!"
	...
	// 23 (Brian Damgaard: The YASGen Collection)
	"########!"
	"# $   +#!"
	"#  $ #*#!"
	"#  $ # #!"
	...
	// 24 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#@*    #!"
	"#$ **$ #!"
	"#.$ .  #!"
	...
	// 25 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#@$  . #!"
	"#** * $#!"
	"# $*. .#!"
	...
	// 26 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#    . #!"
	"#$#$.$ #!"
	"# $ #*.#!"
	...
	// 27 (Brian Damgaard: The YASGen Collection)
	"########!"
	"#@.$ *.#!"
	"#$$. $ #!"
	"#.# $ *#!"
	...
	// 28 (Brian Damgaard: The YASGen Collection)
	"#########!"
	"#.$.  *@#!"
	"#  .$*$$#!"
	"## $* * #!"
...
const sCollect DamgaardCol[] = {
	{ "The YASGen Collection", DamgaardCol1, count_of(DamgaardCol1)/2 },
};

const int DamgaardColNum = count_of(DamgaardCol);
