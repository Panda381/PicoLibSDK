...
extern const u8 LogoImg[4896] __attribute__ ((aligned(4)));
#define LOGOW 144
#define LOGOH 34
...
extern const u8 SpritesImg[27200] __attribute__ ((aligned(4)));
#define SPRITEW 20
#define SPRITEH 20
...
extern const u8 StatusImg[1100] __attribute__ ((aligned(4)));
#define STATUSW 11
#define STATUSH 11
#define STATUSIMGW 100


// format: 8-bit pixel graphics
// image width: 432 pixels
// image height: 10 lines
// image pitch: 432 bytes
extern const u8 TilesImg[4320] __attribute__ ((aligned(4)));
#define TILEW 10
#define TILEH 10
#define TILESIZE 10
#define TILESIMGW 432
