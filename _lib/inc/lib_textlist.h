...
// add new empty text entry (returns index or -1 on memory error)
int TextListNew(sTextList* list);

// add new string entry with length (returns index or -1 on memory error)
int TextListAddStrLen(sTextList* list, const char* text, int len);

// add new string entry (returns index or -1 on memory error)
INLINE int TextListAddStr(sTextList* list, const char* text)
	{ return TextListAddStrLen(list, text, -1); }

// add new text entry (returns index or -1 on memory error)
...
// duplicate text entry (returns index or -1 on error)
