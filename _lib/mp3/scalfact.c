 ...
 *
 * Inputs:      BitStreamInfo, sMP3SideInfoSub, sMP3ScaleFactorInfoSub structs for this
 *                granule/channel
 *              vector of scfsi flags from side info, length = 4 (MP3_MAX_SCFBD)
 *              index of current granule
 *              sMP3ScaleFactorInfoSub from granule 0 (for granule 1, if scfsi[i] is set, 
 ...
 **************************************************************************************/
static void UnpackSFMPEG1(BitStreamInfo *bsi, sMP3SideInfoSub *sis, sMP3ScaleFactorInfoSub *sfis, int *scfsi, int gr, sMP3ScaleFactorInfoSub *sfisGr0)
{
	int sfb;
	int slen0, slen1;
 ...
 *              sMP3ScaleFactorInfoSub from this granule 
 *              modeExt field from frame header, to tell whether intensity stereo is on
 *              sMP3ScaleFactorJS struct for storing IIP info used in Dequant()
 *
 * Outputs:     updated BitStreamInfo struct
 *              scalefactors in sfis (short and/or long arrays, as appropriate)
 ...
 *                with (x / m) * m, etc.)
 **************************************************************************************/
static void UnpackSFMPEG2(BitStreamInfo *bsi, sMP3SideInfoSub *sis, sMP3ScaleFactorInfoSub *sfis, int gr, int ch, int modeExt, sMP3ScaleFactorJS *sfjs)
{
 ...
 *
 * Inputs:      sMP3DecInfo structure filled by UnpackFrameHeader() and UnpackSideInfo()
 ...
 *              index of current granule and channel
 *
 * Outputs:     updated platform-specific sMP3ScaleFactorInfo struct
 *              updated bitOffset
 *
...
int UnpackScaleFactors(sMP3DecInfo *mp3DecInfo, const u8 *buf, int *bitOffset, int bitsAvail, int gr, int ch)
{
	...
	sfi = ((sMP3ScaleFactorInfo *)(mp3DecInfo->ScaleFactorInfoPS));
