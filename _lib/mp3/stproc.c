 ...
 *              valid sMP3FrameHeader struct
 *              two each of sMP3ScaleFactorInfoSub, sMP3CriticalBandInfo structs (both channels)
 ...
 *              valid sMP3FrameHeader struct
 *              two each of sMP3ScaleFactorInfoSub, sMP3CriticalBandInfo structs (both channels)
 *              sMP3ScaleFactorJS struct with joint stereo info from UnpackSFMPEG2()
 *              flags indicating midSide on/off, mixedBlock on/off
 *              guard bit mask (left and right channels)
 *
 * Outputs:     updated sample vector x
