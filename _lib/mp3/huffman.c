...
static int DecodeHuffmanPairs(int *xy, int nVals, int tabIdx, int bitsLeft, const u8 *buf, int bitOffset)
{
	int i, x, y;
 ...
 **************************************************************************************/
// no improvement with section=data
static int DecodeHuffmanQuads(int *vwxy, int nVals, int tabIdx, int bitsLeft, const u8 *buf, int bitOffset)
{
	int i, v, w, x, y;
	...
	tBase = (const u8 *)quadTable + quadTabOffset[tabIdx];
