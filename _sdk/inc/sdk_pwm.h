...
INLINE void PWM_IntClear(u8 pwm) { *PWM_INTR = BIT(pwm); }

// enable interrupt
INLINE void PWM_IntEnable(u8 pwm) { RegSet(PWM_INTE, BIT(pwm)); }

// disable interrupt
INLINE void PWM_IntDisable(u8 pwm) { RegClr(PWM_INTE, BIT(pwm)); }

// force interrupt
INLINE void PWM_IntForce(u8 pwm) { RegSet(PWM_INTF, BIT(pwm)); }

// unforce interrupt
INLINE void PWM_IntUnforce(u8 pwm) { RegClr(PWM_INTF, BIT(pwm)); }
