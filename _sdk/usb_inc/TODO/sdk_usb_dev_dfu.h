...
// ****************************************************************************
//
//                 USB Firmware Upgrade Device Class (device)
//
// ****************************************************************************
...
#ifndef _SDK_USB_DFUD_H
#define _SDK_USB_DFUD_H
...
u16 DfudOpen(const sUsbDescItf* itf, u16 max_len);

// control request callback (returns False to stall)
Bool DfudCtrlReq(u8 stage, const sUsbSetupPkt* setup);

// transfer complete callback
Bool DfudXferComp(u8 epinx, u8 xres, u16 len);

#ifdef __cplusplus
}
#endif

#endif // _SDK_USB_DFUD_H

#endif // USE_USB_DEV_DFU	// use USB DFU-RT Device Firmware Upgrade (device)
