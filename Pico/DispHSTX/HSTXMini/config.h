...
#define USE_DRAWCAN	0
#define USE_DRAW	0		// use drawing canvas (lib_drawcan*.c, lib_drawcan*.h)

#define DISPHSTX_DISP_SEL	2		// PicoPadHSTX ... >=0 GPIO pin with display selection switch, -1=do not use display selection switch
