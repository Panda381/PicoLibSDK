...
Output duty cycle = 0.0%, measured input duty cycle = 0.0%
Output duty cycle = 10.0%, measured input duty cycle = 10.0%
Output duty cycle = 50.0%, measured input duty cycle = 50.0%
Output duty cycle = 90.0%, measured input duty cycle = 89.9%
Output duty cycle = 100.0%, measured input duty cycle = 100.0%
*/
...
int main()
{
	...
	int c;
	do {
		printf("Connect GPIO%d with GPIO%d and press spacebar to start...\n", OUTPUT_PIN, MEASURE_PIN);
		c = getchar();
	} while (c != ' ');
