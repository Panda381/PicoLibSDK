...
uint8_t SnD_;
extern uint8_t LevelColor;
extern const uint8_t LvlColR[4]={0,31,31,0};
extern const uint8_t LvlColB[4]={31,31,0,0};
...
uint16_t ColorBuf(uint8_t x_, uint8_t y_) {
        return color(LvlColR[LevelColor], 64 - y_, LvlColB[LevelColor]);
