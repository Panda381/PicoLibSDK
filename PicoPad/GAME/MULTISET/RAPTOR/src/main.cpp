...
int main()
{
	...
	while (True)
	{
		...
		DrawClear();
		SelFont8x16();
		DrawText2("Raptor", (WIDTH - 6*16)/2, 0, COL_YELLOW);

#define MENUX 10
#define MENUY 60
#define MENUDY 16
		DrawText("Game control:", MENUX+16, MENUY+0*MENUDY, COL_GREEN);
		DrawText("arrows .......... Move spaceship", MENUX, MENUY+1*MENUDY, COL_WHITE);
		DrawText("A ............... Shooting", MENUX, MENUY+2*MENUDY, COL_WHITE);
		DrawText("X ............... Select weapon", MENUX, MENUY+3*MENUDY, COL_WHITE);
		DrawText("Y ............... Quit the game", MENUX, MENUY+4*MENUDY, COL_WHITE);
		DrawText("Press key 'A' to start the game", MENUX+16, MENUY+5*MENUDY, COL_GREEN);
