...
#define MENUY 36
#define MENUDY 16
		DrawText("Setup players:", MENUX+16, MENUY+0*MENUDY, COL_GREEN);
...
#define MENUY2 (MENUY+8*MENUDY+4)
		...
		DrawText("A ........ Put electron into atom", MENUX, MENUY2+2*MENUDY, COL_WHITE);
		DrawText("Y ........ Quit the game", MENUX, MENUY2+3*MENUDY, COL_WHITE);
