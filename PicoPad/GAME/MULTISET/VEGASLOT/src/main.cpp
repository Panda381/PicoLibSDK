...
int main()
{
	...
	while (True)
	{
		...
		DrawClear();
		SelFont8x16();
		DrawText2("VegaSlot", (WIDTH - 8*16)/2, 0, COL_YELLOW);

#define MENUX 10
#define MENUY 60
#define MENUDY 16
		DrawText("Game control:", MENUX+16, MENUY+0*MENUDY, COL_GREEN);
		DrawText("A ........ Start the game/toss/risk", MENUX, MENUY+1*MENUDY, COL_WHITE);
		DrawText("B ........ Change the bet", MENUX, MENUY+2*MENUDY, COL_WHITE);
		DrawText("X ........ Auto-start", MENUX, MENUY+3*MENUDY, COL_WHITE);
		DrawText("LEFT ..... Toss, transfer win to bank", MENUX, MENUY+4*MENUDY, COL_WHITE);
		DrawText("RIGHT .... Transfer win to credit", MENUX, MENUY+5*MENUDY, COL_WHITE);
		DrawText("UP ....... Add 10 credits", MENUX, MENUY+6*MENUDY, COL_WHITE);
		DrawText("DOWN ..... Bank to credit, payout", MENUX, MENUY+7*MENUDY, COL_WHITE);
		DrawText("Y ........ Quit the game", MENUX, MENUY+8*MENUDY, COL_WHITE);
		DrawText("Press key 'A' to start the game", MENUX+16, MENUY+9*MENUDY, COL_GREEN);
