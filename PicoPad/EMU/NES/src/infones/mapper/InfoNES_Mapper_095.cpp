...
typedef struct {
	BYTE	md_Map95_Regs[ 1 ];	// 0x00
	u8	md_res[3];		// 0x01
	DWORD	md_Map95_Prg0;		// 0x04
	DWORD	md_Map95_Prg1;		// 0x08
	DWORD	md_Map95_Chr01;		// 0x0C
	DWORD	md_Map95_Chr23;		// 0x10
	DWORD	md_Map95_Chr4;		// 0x14
	DWORD	md_Map95_Chr5;		// 0x18
	DWORD	md_Map95_Chr6;		// 0x1C
	DWORD	md_Map95_Chr7;		// 0x20
} sMap95_Data;

STATIC_ASSERT((sizeof(sMap95_Data) == 0x24) && (sizeof(sMap95_Data) <= MAPDATA_SIZE), "Incorrect sMap95_Data!");

#define MAPDATA95		((sMap95_Data*)NES->mapdata)	// mapper data

#define Map95_Regs		MAPDATA95->md_Map95_Regs
#define Map95_Prg0		MAPDATA95->md_Map95_Prg0
#define Map95_Prg1		MAPDATA95->md_Map95_Prg1
#define Map95_Chr01		MAPDATA95->md_Map95_Chr01
#define Map95_Chr23		MAPDATA95->md_Map95_Chr23
#define Map95_Chr4		MAPDATA95->md_Map95_Chr4
#define Map95_Chr5		MAPDATA95->md_Map95_Chr5
#define Map95_Chr6		MAPDATA95->md_Map95_Chr6
#define Map95_Chr7		MAPDATA95->md_Map95_Chr7
