...
typedef struct {
	BYTE	md_Map41_Regs[ 2 ];	// 0x00
	u8	md_res[2];		// 0x02
} sMap41_Data;

STATIC_ASSERT((sizeof(sMap41_Data) == 0x04) && (sizeof(sMap41_Data) <= MAPDATA_SIZE), "Incorrect sMap41_Data!");

#define MAPDATA41		((sMap41_Data*)NES->mapdata)	// mapper data

#define Map41_Regs	MAPDATA41->md_Map41_Regs
