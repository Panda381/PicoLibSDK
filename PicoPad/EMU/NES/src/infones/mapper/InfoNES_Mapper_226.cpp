...
typedef struct {
	BYTE	md_Map226_Reg[2];	// 0x00
	u8	md_res[2];		// 0x02
} sMap226_Data;

STATIC_ASSERT((sizeof(sMap226_Data) == 0x04) && (sizeof(sMap226_Data) <= MAPDATA_SIZE), "Incorrect sMap226_Data!");

#define MAPDATA226		((sMap226_Data*)NES->mapdata)	// mapper data

#define Map226_Reg	MAPDATA226->md_Map226_Reg
