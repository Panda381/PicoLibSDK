...
typedef struct {
	BYTE	md_Map112_Regs[8];	// 0x00
	BYTE	md_Map112_IRQ_Enable;	// 0x08  /* IRQs enabled */
	BYTE	md_Map112_IRQ_Cnt;	// 0x09  /* IRQ scanline counter, decreasing */
	BYTE	md_Map112_IRQ_Latch;	// 0x0A  /* IRQ scanline counter latch */
	u8	md_res;			// 0x0B
	DWORD	md_Map112_Prg0;		// 0x0C
	DWORD	md_Map112_Prg1;		// 0x10
	DWORD	md_Map112_Chr01;	// 0x14
	DWORD	md_Map112_Chr23;	// 0x18
	DWORD	md_Map112_Chr4;		// 0x1C
	DWORD	md_Map112_Chr5;		// 0x20
	DWORD	md_Map112_Chr6;		// 0x24
	DWORD	md_Map112_Chr7;		// 0x28
} sMap112_Data;

STATIC_ASSERT((sizeof(sMap112_Data) == 0x2C) && (sizeof(sMap112_Data) <= MAPDATA_SIZE), "Incorrect sMap112_Data!");

#define MAPDATA112		((sMap112_Data*)NES->mapdata)	// mapper data

#define Map112_Regs		MAPDATA112->md_Map112_Regs	
#define Map112_IRQ_Enable	MAPDATA112->md_Map112_IRQ_Enable	/* IRQs enabled */
#define Map112_IRQ_Cnt		MAPDATA112->md_Map112_IRQ_Cnt		/* IRQ scanline counter, decreasing */
#define Map112_IRQ_Latch	MAPDATA112->md_Map112_IRQ_Latch		/* IRQ scanline counter latch */
#define Map112_Prg0		MAPDATA112->md_Map112_Prg0	
#define Map112_Prg1		MAPDATA112->md_Map112_Prg1	
#define Map112_Chr01		MAPDATA112->md_Map112_Chr01	
#define Map112_Chr23		MAPDATA112->md_Map112_Chr23	
#define Map112_Chr4		MAPDATA112->md_Map112_Chr4	
#define Map112_Chr5		MAPDATA112->md_Map112_Chr5	
#define Map112_Chr6		MAPDATA112->md_Map112_Chr6	
#define Map112_Chr7		MAPDATA112->md_Map112_Chr7	
