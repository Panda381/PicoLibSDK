...
typedef struct {
	BYTE	md_Map134_Cmd;	// 0x00
	BYTE	md_Map134_Prg;	// 0x01
	BYTE	md_Map134_Chr;	// 0x02
	u8	md_res;		// 0x03
} sMap134_Data;

STATIC_ASSERT((sizeof(sMap134_Data) == 0x04) && (sizeof(sMap134_Data) <= MAPDATA_SIZE), "Incorrect sMap134_Data!");

#define MAPDATA134	((sMap134_Data*)NES->mapdata)	// mapper data

#define Map134_Cmd	MAPDATA134->md_Map134_Cmd
#define Map134_Prg	MAPDATA134->md_Map134_Prg
#define Map134_Chr	MAPDATA134->md_Map134_Chr
