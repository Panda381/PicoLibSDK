...
typedef struct {
	BYTE	md_Map249_Reg[8];	// 0x00
	BYTE	md_Map249_Spdata;	// 0x08
	BYTE	md_Map249_IRQ_Enable;	// 0x09
	BYTE	md_Map249_IRQ_Counter;	// 0x0A
	BYTE	md_Map249_IRQ_Latch;	// 0x0B
	BYTE	md_Map249_IRQ_Request;	// 0x0C
	u8	md_res[3];		// 0x0D
} sMap249_Data;

STATIC_ASSERT((sizeof(sMap249_Data) == 0x10) && (sizeof(sMap249_Data) <= MAPDATA_SIZE), "Incorrect sMap249_Data!");

#define MAPDATA249		((sMap249_Data*)NES->mapdata)	// mapper data

#define Map249_Reg		MAPDATA249->md_Map249_Reg
#define Map249_Spdata		MAPDATA249->md_Map249_Spdata
#define Map249_IRQ_Enable	MAPDATA249->md_Map249_IRQ_Enable
#define Map249_IRQ_Counter	MAPDATA249->md_Map249_IRQ_Counter
#define Map249_IRQ_Latch	MAPDATA249->md_Map249_IRQ_Latch
#define Map249_IRQ_Request	MAPDATA249->md_Map249_IRQ_Request
