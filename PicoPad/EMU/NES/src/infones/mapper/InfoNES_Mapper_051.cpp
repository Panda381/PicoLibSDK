...
typedef struct {
	s32	md_Map51_Mode;	// 0x00
	s32	md_Map51_Bank;	// 0x04
} sMap51_Data;

STATIC_ASSERT((sizeof(sMap51_Data) == 0x08) && (sizeof(sMap51_Data) <= MAPDATA_SIZE), "Incorrect sMap51_Data!");

#define MAPDATA51		((sMap51_Data*)NES->mapdata)	// mapper data

#define Map51_Mode	MAPDATA51->md_Map51_Mode
#define Map51_Bank	MAPDATA51->md_Map51_Bank
