...
typedef struct {
	struct Map10_Latch	md_latch3;	// 0x00
	struct Map10_Latch	md_latch4;	// 0x04
} sMap10_Data;

STATIC_ASSERT((sizeof(sMap10_Data) == 0x08) && (sizeof(sMap10_Data) <= MAPDATA_SIZE), "Incorrect sMap10_Data!");

#define MAPDATA10	((sMap10_Data*)NES->mapdata)	// mapper data

// struct Map10_Latch latch3;    // Latch Selector #1
#define latch3		MAPDATA10->md_latch3

// struct Map10_Latch latch4;    // Latch Selector #2
#define latch4		MAPDATA10->md_latch4
