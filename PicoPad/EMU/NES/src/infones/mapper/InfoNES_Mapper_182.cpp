...
typedef struct {
	BYTE	md_Map182_Regs[1];	// 0x00
	BYTE	md_Map182_IRQ_Enable;	// 0x01
	BYTE	md_Map182_IRQ_Cnt;	// 0x02
	u8	md_res;			// 0x03
} sMap182_Data;

STATIC_ASSERT((sizeof(sMap182_Data) == 0x04) && (sizeof(sMap182_Data) <= MAPDATA_SIZE), "Incorrect sMap182_Data!");

#define MAPDATA182		((sMap182_Data*)NES->mapdata)	// mapper data

#define Map182_Regs		MAPDATA182->md_Map182_Regs
#define Map182_IRQ_Enable	MAPDATA182->md_Map182_IRQ_Enable
#define Map182_IRQ_Cnt		MAPDATA182->md_Map182_IRQ_Cnt
