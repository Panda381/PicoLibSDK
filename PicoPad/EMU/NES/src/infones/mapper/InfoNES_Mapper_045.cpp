...
typedef struct {
	BYTE	md_Map45_Regs[7];	// 0x00
	BYTE	md_Map45_IRQ_Enable;	// 0x07
	BYTE	md_Map45_IRQ_Cnt;	// 0x08
	BYTE	md_Map45_IRQ_Latch;	// 0x09
	u8	md_res[2];		// 0x0A
	DWORD	md_Map45_P[4];		// 0x0C
	DWORD	md_Map45_Prg0;		// 0x1C
	DWORD	md_Map45_Prg1;		// 0x20
	DWORD	md_Map45_Prg2;		// 0x24
	DWORD	md_Map45_Prg3;		// 0x28
	DWORD	md_Map45_C[8];		// 0x2C
	DWORD	md_Map45_Chr0;		// 0x4C
	DWORD	md_Map45_Chr1;		// 0x50
	DWORD	md_Map45_Chr2;		// 0x54
	DWORD	md_Map45_Chr3;		// 0x58
	DWORD	md_Map45_Chr4;		// 0x5C
	DWORD	md_Map45_Chr5;		// 0x60
	DWORD	md_Map45_Chr6;		// 0x64
	DWORD	md_Map45_Chr7;		// 0x68
} sMap45_Data;

STATIC_ASSERT((sizeof(sMap45_Data) == 0x6C) && (sizeof(sMap45_Data) <= MAPDATA_SIZE), "Incorrect sMap45_Data!");

#define MAPDATA45		((sMap45_Data*)NES->mapdata)	// mapper data

#define Map45_Regs		MAPDATA45->md_Map45_Regs
#define Map45_IRQ_Enable	MAPDATA45->md_Map45_IRQ_Enable
#define Map45_IRQ_Cnt		MAPDATA45->md_Map45_IRQ_Cnt
#define Map45_IRQ_Latch		MAPDATA45->md_Map45_IRQ_Latch
#define Map45_P			MAPDATA45->md_Map45_P
#define Map45_Prg0		MAPDATA45->md_Map45_Prg0
#define Map45_Prg1		MAPDATA45->md_Map45_Prg1
#define Map45_Prg2		MAPDATA45->md_Map45_Prg2
#define Map45_Prg3		MAPDATA45->md_Map45_Prg3
#define Map45_C			MAPDATA45->md_Map45_C
#define Map45_Chr0		MAPDATA45->md_Map45_Chr0
#define Map45_Chr1		MAPDATA45->md_Map45_Chr1
#define Map45_Chr2		MAPDATA45->md_Map45_Chr2
#define Map45_Chr3		MAPDATA45->md_Map45_Chr3
#define Map45_Chr4		MAPDATA45->md_Map45_Chr4
#define Map45_Chr5		MAPDATA45->md_Map45_Chr5
#define Map45_Chr6		MAPDATA45->md_Map45_Chr6
#define Map45_Chr7		MAPDATA45->md_Map45_Chr7
