...
typedef struct {
	BYTE	md_Map160_IRQ_Enable;	// 0x00
	BYTE	md_Map160_IRQ_Cnt;	// 0x01
	BYTE	md_Map160_IRQ_Latch;	// 0x02
	BYTE	md_Map160_Refresh_Type;	// 0x03
} sMap160_Data;

STATIC_ASSERT((sizeof(sMap160_Data) == 0x04) && (sizeof(sMap160_Data) <= MAPDATA_SIZE), "Incorrect sMap160_Data!");

#define MAPDATA160		((sMap160_Data*)NES->mapdata)	// mapper data

#define Map160_IRQ_Enable	MAPDATA160->md_Map160_IRQ_Enable
#define Map160_IRQ_Cnt		MAPDATA160->md_Map160_IRQ_Cnt
#define Map160_IRQ_Latch	MAPDATA160->md_Map160_IRQ_Latch
#define Map160_Refresh_Type	MAPDATA160->md_Map160_Refresh_Type
