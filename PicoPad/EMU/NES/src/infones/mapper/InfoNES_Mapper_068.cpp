...
typedef struct {
	BYTE	md_Map68_Regs[4];
} sMap68_Data;

STATIC_ASSERT((sizeof(sMap68_Data) == 0x04) && (sizeof(sMap68_Data) <= MAPDATA_SIZE), "Incorrect sMap68_Data!");

#define MAPDATA68		((sMap68_Data*)NES->mapdata)	// mapper data

#define Map68_Regs	MAPDATA68->md_Map68_Regs
...
/*-------------------------------------------------------------------*/
void FASTCODE NOFLASH(Map68_SyncMirror)( void )
{
  if ( Map68_Regs[ 0 ] )
  {
    switch( Map68_Regs[ 1 ] )
