...
typedef struct {
	BYTE	md_Map19_Regs[2];	// 0x00
	BYTE	md_Map19_IRQ_Enable;	// 0x02
	u8	md_res;			// 0x03
	DWORD	md_Map19_IRQ_Cnt;	// 0x04
} sMap19_Data;

STATIC_ASSERT((sizeof(sMap19_Data) == 0x08) && (sizeof(sMap19_Data) <= MAPDATA_SIZE), "Incorrect sMap19_Data!");

#define MAPDATA19		((sMap19_Data*)NES->mapdata)	// mapper data

#define Map19_Regs		MAPDATA19->md_Map19_Regs
#define Map19_IRQ_Enable	MAPDATA19->md_Map19_IRQ_Enable
#define Map19_IRQ_Cnt		MAPDATA19->md_Map19_IRQ_Cnt

// BYTE Map19_Chr_Ram[0x2000];
#define Map19_Chr_Ram		NES->xram

#define MAP19_XRAM_SIZE	0x2000
STATIC_ASSERT(MAP19_XRAM_SIZE <= XRAM_SIZE, "Incorrect MAP19_XRAM_SIZE!");
...
void FASTCODE NOFLASH(Map19_Apu)(WORD wAddr, BYTE byData)
{
  ...
  case 0x5000: /* $5000-57ff */
    Map19_IRQ_Cnt = (((Map19_IRQ_Cnt >> STEP_PER_SCANLINE_SHIFT) & 0xff00) | byData) << STEP_PER_SCANLINE_SHIFT;
    break;

  case 0x5800: /* $5800-5fff */
    Map19_IRQ_Cnt = (((Map19_IRQ_Cnt >> STEP_PER_SCANLINE_SHIFT) & 0x00ff) | ((DWORD)(byData & 0x7f) << 8)) << STEP_PER_SCANLINE_SHIFT;
...
BYTE FASTCODE NOFLASH(Map19_ReadApu)(WORD wAddr)
{
  ...
  case 0x5000: /* $5000-57ff */
    return (BYTE)((Map19_IRQ_Cnt >> STEP_PER_SCANLINE_SHIFT) & 0x00ff);

  case 0x5800: /* $5800-5fff */
    return (BYTE)(((Map19_IRQ_Cnt >> STEP_PER_SCANLINE_SHIFT) & 0x7f00) >> 8);
 ...
 */
  if (Map19_IRQ_Enable)
  {
    if (Map19_IRQ_Cnt >= (DWORD)((0x7fff << STEP_PER_SCANLINE_SHIFT) - STEP_PER_SCANLINE_H))
    {
      Map19_IRQ_Cnt = (0x7fff << STEP_PER_SCANLINE_SHIFT);
    ...
    {
      Map19_IRQ_Cnt += STEP_PER_SCANLINE_H;
    }
  }
}
