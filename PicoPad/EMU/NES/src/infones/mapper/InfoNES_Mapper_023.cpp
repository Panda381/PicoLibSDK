...
typedef struct {
	BYTE	md_Map23_IRQ_Enable;	// 0x00
	BYTE	md_Map23_IRQ_Cnt;	// 0x01
	BYTE	md_Map23_IRQ_Latch;	// 0x02
	BYTE	md_Map23_Regs[ 9 ];	// 0x03
} sMap23_Data;

STATIC_ASSERT((sizeof(sMap23_Data) == 0x0C) && (sizeof(sMap23_Data) <= MAPDATA_SIZE), "Incorrect sMap23_Data!");

#define MAPDATA23		((sMap23_Data*)NES->mapdata)	// mapper data

#define Map23_IRQ_Enable	MAPDATA23->md_Map23_IRQ_Enable
#define Map23_IRQ_Cnt		MAPDATA23->md_Map23_IRQ_Cnt
#define Map23_IRQ_Latch		MAPDATA23->md_Map23_IRQ_Latch
#define Map23_Regs		MAPDATA23->md_Map23_Regs
