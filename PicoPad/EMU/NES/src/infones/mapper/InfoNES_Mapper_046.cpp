...
typedef struct {
	BYTE	md_Map46_Regs[ 4 ];
} sMap46_Data;

STATIC_ASSERT((sizeof(sMap46_Data) == 0x04) && (sizeof(sMap46_Data) <= MAPDATA_SIZE), "Incorrect sMap46_Data!");

#define MAPDATA46		((sMap46_Data*)NES->mapdata)	// mapper data

#define Map46_Regs	MAPDATA46->md_Map46_Regs
