...
typedef struct {
	BYTE	md_Map110_Reg0;		// 0x00
	BYTE	md_Map110_Reg1;		// 0x01
	u8	md_res[2];		// 0x02
} sMap110_Data;

STATIC_ASSERT((sizeof(sMap110_Data) == 0x04) && (sizeof(sMap110_Data) <= MAPDATA_SIZE), "Incorrect sMap110_Data!");

#define MAPDATA110		((sMap110_Data*)NES->mapdata)	// mapper data

#define Map110_Reg0	MAPDATA110->md_Map110_Reg0
#define Map110_Reg1	MAPDATA110->md_Map110_Reg1
