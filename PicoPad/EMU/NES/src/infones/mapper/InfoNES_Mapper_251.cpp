...
typedef struct {
	BYTE	md_Map251_Reg[11];	// 0x00
	BYTE	md_Map251_Breg[4];	// 0x0B
	u8	md_res;			// 0x0F
} sMap251_Data;

STATIC_ASSERT((sizeof(sMap251_Data) == 0x10) && (sizeof(sMap251_Data) <= MAPDATA_SIZE), "Incorrect sMap251_Data!");

#define MAPDATA251		((sMap251_Data*)NES->mapdata)	// mapper data

#define Map251_Reg	MAPDATA251->md_Map251_Reg
#define Map251_Breg	MAPDATA251->md_Map251_Breg
