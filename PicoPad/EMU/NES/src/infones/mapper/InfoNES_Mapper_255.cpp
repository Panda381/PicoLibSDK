...
typedef struct {
	BYTE	md_Map255_Reg[4];
} sMap255_Data;

STATIC_ASSERT((sizeof(sMap255_Data) == 0x04) && (sizeof(sMap255_Data) <= MAPDATA_SIZE), "Incorrect sMap255_Data!");

#define MAPDATA255		((sMap255_Data*)NES->mapdata)	// mapper data

#define Map255_Reg	MAPDATA255->md_Map255_Reg
