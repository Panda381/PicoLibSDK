...
typedef struct {
	BYTE	md_Map5_Wram_Protect0;	// 0x00
	BYTE	md_Map5_Wram_Protect1;	// 0x01
	BYTE	md_Map5_Prg_Size;	// 0x02
	BYTE	md_Map5_Chr_Size;	// 0x03
// aligned
	BYTE	md_Map5_Gfx_Mode;	// 0x04
	BYTE	md_Map5_IRQ_Enable;	// 0x05
	BYTE	md_Map5_IRQ_Status;	// 0x06
	BYTE	md_Map5_IRQ_Line;	// 0x07
// aligned
	BYTE	md_Map5_Prg_Reg[8];	// 0x08
	BYTE	md_Map5_Wram_Reg[8];	// 0x10
	BYTE	md_Map5_Chr_Reg[8][2];	// 0x18
// aligned
	DWORD	md_Map5_Value0;		// 0x28
	DWORD	md_Map5_Value1;		// 0x2C
} sMap5_Data;

STATIC_ASSERT((sizeof(sMap5_Data) == 0x30) && (sizeof(sMap5_Data) <= MAPDATA_SIZE), "Incorrect sMap5_Data!");

#define MAPDATA5		((sMap5_Data*)NES->mapdata)	// mapper data

#define Map5_Wram_Protect0	MAPDATA5->md_Map5_Wram_Protect0
#define Map5_Wram_Protect1	MAPDATA5->md_Map5_Wram_Protect1
#define Map5_Prg_Size		MAPDATA5->md_Map5_Prg_Size
#define Map5_Chr_Size		MAPDATA5->md_Map5_Chr_Size

#define Map5_Gfx_Mode		MAPDATA5->md_Map5_Gfx_Mode
#define Map5_IRQ_Enable		MAPDATA5->md_Map5_IRQ_Enable
#define Map5_IRQ_Status		MAPDATA5->md_Map5_IRQ_Status
#define Map5_IRQ_Line		MAPDATA5->md_Map5_IRQ_Line

#define Map5_Prg_Reg		MAPDATA5->md_Map5_Prg_Reg
#define Map5_Wram_Reg		MAPDATA5->md_Map5_Wram_Reg
#define Map5_Chr_Reg		MAPDATA5->md_Map5_Chr_Reg

#define Map5_Value0		MAPDATA5->md_Map5_Value0
#define Map5_Value1		MAPDATA5->md_Map5_Value1

// BYTE Map5_Wram[0x2000 * 8];
#define Map5_Wram	NES->xram

// BYTE Map5_Ex_Ram[0x400];
#define Map5_Ex_Ram	(&NES->xram[0x2000*8])

// BYTE Map5_Ex_Vram[0x400];
#define Map5_Ex_Vram	(&NES->xram[0x2000*8 + 0x400])

// BYTE Map5_Ex_Nam[0x400];
#define Map5_Ex_Nam	(&NES->xram[0x2000*8 + 0x400 + 0x400])

#define MAP5_XRAM_SIZE	(0x2000*8 + 0x400 + 0x400 + 0x400)
STATIC_ASSERT(MAP5_XRAM_SIZE <= XRAM_SIZE, "Incorrect MAP5_XRAM_SIZE!");
...
/*-------------------------------------------------------------------*/
void FASTCODE NOFLASH(Map5_Sram)(WORD wAddr, BYTE byData)
{
