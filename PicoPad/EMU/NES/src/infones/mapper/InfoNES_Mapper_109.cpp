...
typedef struct {
	BYTE	md_Map109_Reg;		// 0x00
	BYTE	md_Map109_Chr0;		// 0x01
	BYTE	md_Map109_Chr1;		// 0x02
	BYTE	md_Map109_Chr2;		// 0x03
	BYTE	md_Map109_Chr3;		// 0x04
	BYTE	md_Map109_Chrmode0;	// 0x05
	BYTE	md_Map109_Chrmode1;	// 0x06
	u8	md_res;			// 0x07
} sMap109_Data;

STATIC_ASSERT((sizeof(sMap109_Data) == 0x08) && (sizeof(sMap109_Data) <= MAPDATA_SIZE), "Incorrect sMap109_Data!");

#define MAPDATA109		((sMap109_Data*)NES->mapdata)	// mapper data

#define Map109_Reg		MAPDATA109->md_Map109_Reg
#define Map109_Chr0		MAPDATA109->md_Map109_Chr0
#define Map109_Chr1		MAPDATA109->md_Map109_Chr1
#define Map109_Chr2		MAPDATA109->md_Map109_Chr2
#define Map109_Chr3		MAPDATA109->md_Map109_Chr3
#define Map109_Chrmode0		MAPDATA109->md_Map109_Chrmode0
#define Map109_Chrmode1		MAPDATA109->md_Map109_Chrmode1
