...
typedef struct {
	BYTE	md_Map252_Reg[9];	// 0x00
	BYTE	md_Map252_IRQ_Enable;	// 0x09
	BYTE	md_Map252_IRQ_Counter;	// 0x0A
	BYTE	md_Map252_IRQ_Latch;	// 0x0B
	BYTE	md_Map252_IRQ_Occur;	// 0x0C
	u8	md_res[3];		// 0x0D
	s32	md_Map252_IRQ_Clock;	// 0x10
} sMap252_Data;

STATIC_ASSERT((sizeof(sMap252_Data) == 0x14) && (sizeof(sMap252_Data) <= MAPDATA_SIZE), "Incorrect sMap252_Data!");

#define MAPDATA252		((sMap252_Data*)NES->mapdata)	// mapper data

#define Map252_Reg		MAPDATA252->md_Map252_Reg
#define Map252_IRQ_Enable	MAPDATA252->md_Map252_IRQ_Enable
#define Map252_IRQ_Counter	MAPDATA252->md_Map252_IRQ_Counter
#define Map252_IRQ_Latch	MAPDATA252->md_Map252_IRQ_Latch
#define Map252_IRQ_Occur	MAPDATA252->md_Map252_IRQ_Occur
#define Map252_IRQ_Clock	MAPDATA252->md_Map252_IRQ_Clock
