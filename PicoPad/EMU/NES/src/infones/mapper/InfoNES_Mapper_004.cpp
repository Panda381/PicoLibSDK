...
typedef struct {
	BYTE	md_Map4_IRQ_Enable;		// 0x00
	BYTE	md_Map4_IRQ_Cnt;		// 0x01
	BYTE	md_Map4_IRQ_Latch;		// 0x02
	BYTE	md_Map4_IRQ_Request;		// 0x03
// aligned
	BYTE	md_Map4_IRQ_Present;		// 0x04
	BYTE	md_Map4_IRQ_Present_Vbl;	// 0x05
	u8	res[2];				// 0x06
// aligned
	BYTE	md_Map4_Regs[ 8 ];		// 0x08
// aligned
	DWORD	md_Map4_Rom_Bank;		// 0x10
	DWORD	md_Map4_Prg0;			// 0x14
	DWORD	md_Map4_Prg1;			// 0x18
	DWORD	md_Map4_Chr01;			// 0x1C
	DWORD	md_Map4_Chr23;			// 0x20
	DWORD	md_Map4_Chr4;			// 0x24
	DWORD	md_Map4_Chr5;			// 0x28
	DWORD	md_Map4_Chr6;			// 0x2C
	DWORD	md_Map4_Chr7;			// 0x30
} sMap4_Data;

STATIC_ASSERT((sizeof(sMap4_Data) == 0x34) && (sizeof(sMap4_Data) <= MAPDATA_SIZE), "Incorrect sMap4_Data!");

#define MAPDATA4	((sMap4_Data*)NES->mapdata)	// mapper data

#define Map4_IRQ_Enable		MAPDATA4->md_Map4_IRQ_Enable
#define Map4_IRQ_Cnt		MAPDATA4->md_Map4_IRQ_Cnt
#define Map4_IRQ_Latch		MAPDATA4->md_Map4_IRQ_Latch
#define Map4_IRQ_Request	MAPDATA4->md_Map4_IRQ_Request

#define Map4_IRQ_Present	MAPDATA4->md_Map4_IRQ_Present
#define Map4_IRQ_Present_Vbl	MAPDATA4->md_Map4_IRQ_Present_Vbl

#define Map4_Regs		MAPDATA4->md_Map4_Regs

#define Map4_Rom_Bank		MAPDATA4->md_Map4_Rom_Bank
#define Map4_Prg0		MAPDATA4->md_Map4_Prg0
#define Map4_Prg1		MAPDATA4->md_Map4_Prg1
#define Map4_Chr01		MAPDATA4->md_Map4_Chr01
#define Map4_Chr23		MAPDATA4->md_Map4_Chr23
#define Map4_Chr4		MAPDATA4->md_Map4_Chr4
#define Map4_Chr5		MAPDATA4->md_Map4_Chr5
#define Map4_Chr6		MAPDATA4->md_Map4_Chr6
#define Map4_Chr7		MAPDATA4->md_Map4_Chr7
