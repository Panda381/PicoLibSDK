...
#define Map185_Dummy_Chr_Rom	NES->xram

#define MAP185_XRAM_SIZE	0x400
STATIC_ASSERT(MAP185_XRAM_SIZE <= XRAM_SIZE, "Incorrect MAP185_XRAM_SIZE!");
...
void Map185_Init()
{
  ...
  int nPage;
  for ( nPage = 0; nPage < MAP185_XRAM_SIZE; nPage++ )
  {
