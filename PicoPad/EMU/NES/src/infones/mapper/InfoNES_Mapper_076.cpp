...
typedef struct {
	BYTE	md_Map76_Reg;	// 0x00
	u8	res[3];		// 0x01
} sMap76_Data;

STATIC_ASSERT((sizeof(sMap76_Data) == 0x04) && (sizeof(sMap76_Data) <= MAPDATA_SIZE), "Incorrect sMap76_Data!");

#define MAPDATA76	((sMap76_Data*)NES->mapdata)	// mapper data

#define Map76_Reg	MAPDATA76->md_Map76_Reg
