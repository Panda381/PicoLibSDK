...
typedef struct {
	BYTE	md_Map105_Reg[4];		// 0x00
	BYTE	md_Map105_Init_State;		// 0x04
	BYTE	md_Map105_Write_Count;		// 0x05
	BYTE	md_Map105_Bits;			// 0x06
	BYTE	md_Map105_IRQ_Enable;		// 0x07
	s32	md_Map105_IRQ_Counter;		// 0x08
} sMap105_Data;

STATIC_ASSERT((sizeof(sMap105_Data) == 0x0C) && (sizeof(sMap105_Data) <= MAPDATA_SIZE), "Incorrect sMap105_Data!");

#define MAPDATA105		((sMap105_Data*)NES->mapdata)	// mapper data

#define Map105_Reg		MAPDATA105->md_Map105_Reg
#define Map105_Init_State	MAPDATA105->md_Map105_Init_State
#define Map105_Write_Count	MAPDATA105->md_Map105_Write_Count
#define Map105_Bits		MAPDATA105->md_Map105_Bits
#define Map105_IRQ_Enable	MAPDATA105->md_Map105_IRQ_Enable
#define Map105_IRQ_Counter	MAPDATA105->md_Map105_IRQ_Counter
