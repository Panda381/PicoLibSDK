...
typedef struct {
	BYTE	md_Map187_ExtMode;	// 0x00
	BYTE	md_Map187_ChrMode;	// 0x01
	BYTE	md_Map187_ExtEnable;	// 0x02
	BYTE	md_Map187_IRQ_Enable;	// 0x03
	BYTE	md_Map187_IRQ_Counter;	// 0x04
	BYTE	md_Map187_IRQ_Latch;	// 0x05
	BYTE	md_Map187_IRQ_Occur;	// 0x06
	BYTE	md_Map187_LastWrite;	// 0x07
	BYTE	md_Map187_Prg[4];	// 0x08
	BYTE	md_Map187_Bank[8];	// 0x0C
	s32	md_Map187_Chr[8];	// 0x14
} sMap187_Data;

STATIC_ASSERT((sizeof(sMap187_Data) == 0x34) && (sizeof(sMap187_Data) <= MAPDATA_SIZE), "Incorrect sMap187_Data!");

#define MAPDATA187		((sMap187_Data*)NES->mapdata)	// mapper data

#define Map187_ExtMode		MAPDATA187->md_Map187_ExtMode
#define Map187_ChrMode		MAPDATA187->md_Map187_ChrMode
#define Map187_ExtEnable	MAPDATA187->md_Map187_ExtEnable
#define Map187_IRQ_Enable	MAPDATA187->md_Map187_IRQ_Enable
#define Map187_IRQ_Counter	MAPDATA187->md_Map187_IRQ_Counter
#define Map187_IRQ_Latch	MAPDATA187->md_Map187_IRQ_Latch
#define Map187_IRQ_Occur	MAPDATA187->md_Map187_IRQ_Occur
#define Map187_LastWrite	MAPDATA187->md_Map187_LastWrite
#define Map187_Prg		MAPDATA187->md_Map187_Prg
#define Map187_Bank		MAPDATA187->md_Map187_Bank
#define Map187_Chr		MAPDATA187->md_Map187_Chr
