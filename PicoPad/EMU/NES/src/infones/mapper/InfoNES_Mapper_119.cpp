...
typedef struct {
	BYTE	md_Map119_Reg[8];	// 0x00
	BYTE	md_Map119_Prg0;		// 0x08
	BYTE	md_Map119_Prg1;		// 0x09
	BYTE	md_Map119_Chr01;	// 0x0A
	BYTE	md_Map119_Chr23;	// 0x0B
	BYTE	md_Map119_Chr4;		// 0x0C
	BYTE	md_Map119_Chr5;		// 0x0D
	BYTE	md_Map119_Chr6;		// 0x0E
	BYTE	md_Map119_Chr7;		// 0x0F
	BYTE	md_Map119_WeSram;	// 0x10
	BYTE	md_Map119_IRQ_Enable;	// 0x11
	BYTE	md_Map119_IRQ_Counter;	// 0x12
	BYTE	md_Map119_IRQ_Latch;	// 0x13
} sMap119_Data;

STATIC_ASSERT((sizeof(sMap119_Data) == 0x14) && (sizeof(sMap119_Data) <= MAPDATA_SIZE), "Incorrect sMap119_Data!");

#define MAPDATA119		((sMap119_Data*)NES->mapdata)	// mapper data

#define Map119_Reg		MAPDATA119->md_Map119_Reg
#define Map119_Prg0		MAPDATA119->md_Map119_Prg0
#define Map119_Prg1		MAPDATA119->md_Map119_Prg1
#define Map119_Chr01		MAPDATA119->md_Map119_Chr01
#define Map119_Chr23		MAPDATA119->md_Map119_Chr23
#define Map119_Chr4		MAPDATA119->md_Map119_Chr4
#define Map119_Chr5		MAPDATA119->md_Map119_Chr5
#define Map119_Chr6		MAPDATA119->md_Map119_Chr6
#define Map119_Chr7		MAPDATA119->md_Map119_Chr7
#define Map119_WeSram		MAPDATA119->md_Map119_WeSram
#define Map119_IRQ_Enable	MAPDATA119->md_Map119_IRQ_Enable
#define Map119_IRQ_Counter	MAPDATA119->md_Map119_IRQ_Counter
#define Map119_IRQ_Latch	MAPDATA119->md_Map119_IRQ_Latch
