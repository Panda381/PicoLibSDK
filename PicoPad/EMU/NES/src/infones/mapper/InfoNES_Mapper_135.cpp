...
typedef struct {
	BYTE    md_Map135_Cmd;		// 0x00
	BYTE	md_Map135_Chr0l;	// 0x01
	BYTE	md_Map135_Chr1l;	// 0x02
	BYTE	md_Map135_Chr0h;	// 0x03
	BYTE	md_Map135_Chr1h;	// 0x04
	BYTE	md_Map135_Chrch;	// 0x05
	u8	md_res[2];		// 0x06
} sMap135_Data;

STATIC_ASSERT((sizeof(sMap135_Data) == 0x08) && (sizeof(sMap135_Data) <= MAPDATA_SIZE), "Incorrect sMap135_Data!");

#define MAPDATA135		((sMap135_Data*)NES->mapdata)	// mapper data

#define Map135_Cmd	MAPDATA135->md_Map135_Cmd
#define Map135_Chr0l	MAPDATA135->md_Map135_Chr0l
#define Map135_Chr1l	MAPDATA135->md_Map135_Chr1l
#define Map135_Chr0h	MAPDATA135->md_Map135_Chr0h
#define Map135_Chr1h	MAPDATA135->md_Map135_Chr1h
#define Map135_Chrch	MAPDATA135->md_Map135_Chrch
...
void FASTCODE NOFLASH(Map135_Apu)( WORD wAddr, BYTE byData )
{
  ...
  case	0x4101:
    ...
    case	7:
      ...
      case	0: InfoNES_Mirroring( MIRROR_1 ); break;
      case	1: InfoNES_Mirroring( MIRROR_H ); break;
      case	2: InfoNES_Mirroring( MIRROR_V ); break;
      case	3: InfoNES_Mirroring( MIRROR_1 ); break;
      }
      break;
    }
    break;
