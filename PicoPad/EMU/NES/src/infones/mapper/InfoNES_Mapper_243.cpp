...
typedef struct {
	BYTE	md_Map243_Regs[4];
} sMap243_Data;

STATIC_ASSERT((sizeof(sMap243_Data) == 0x04) && (sizeof(sMap243_Data) <= MAPDATA_SIZE), "Incorrect sMap243_Data!");

#define MAPDATA243		((sMap243_Data*)NES->mapdata)	// mapper data

#define Map243_Regs	MAPDATA243->md_Map243_Regs
