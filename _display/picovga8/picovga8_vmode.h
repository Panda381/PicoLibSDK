...
#ifndef _PICOVGA8_VMODE_H
#define _PICOVGA8_VMODE_H

#include "../../_lib/inc/lib_canvas.h"	// canvas
...
typedef struct {
	...
	Bool	vsync;			// use separate VSYNC instead of CSYNC (only progressive mode)
} sVgaCfg;
