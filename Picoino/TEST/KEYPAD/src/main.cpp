...
int main()
{
	...
	while (True)
	{
		...
		// A
		DispKey(WIDTH/8*5, HEIGHT/8*6, "Spc", KeyPressed(KEY_A));

		// B
		DispKey(WIDTH/8*7, HEIGHT/8*5, "Z", KeyPressed(KEY_B));

		// X
		DispKey(WIDTH/8*5, HEIGHT/8*3, "Ctrl", KeyPressed(KEY_X));

		// Y
		DispKey(WIDTH/8*7, HEIGHT/8*2, "Back", KeyPressed(KEY_Y));
