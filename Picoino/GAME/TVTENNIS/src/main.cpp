...
{
	DrawRect((WIDTH - NETW)/2, 0, NETW, height, COL_AZURE);
}
...
#else
		DrawText("Spc ....... Play with tied paddles", MENUX, MENUY+5*MENUDY, COL_WHITE);
#endif
...
#else
		DrawText("Ctrl/Spc ........ Right paddle", MENUX, MENUY2+3*MENUDY, COL_WHITE);
		DrawText("Back ............ Quit the game", MENUX, MENUY2+4*MENUDY, COL_WHITE);
#endif
