...
#define MENUDY 20
		...
		DrawText("1 ........ Player 1 is", MENUX, MENUY+1*MENUDY, Players[0].color);
		DrawText("2 ........ Player 2 is", MENUX, MENUY+2*MENUDY, Players[1].color);
		DrawText("3 ........ Player 3 is", MENUX, MENUY+3*MENUDY, Players[2].color);
		DrawText("4 ........ Player 4 is", MENUX, MENUY+4*MENUDY, Players[3].color);
		DrawText("5 ........ Player 5 is", MENUX, MENUY+5*MENUDY, Players[4].color);

		DrawText("Space .... Start The Game", MENUX, MENUY+6*MENUDY+10, COL_WHITE);
