...
void ChickenMove1()
{
	...
	// new direction
	int dir = 0;
	if (UsbKeyIsPressed(HID_KEY_ARROW_UP)) dir = UP;
	if (UsbKeyIsPressed(HID_KEY_ARROW_DOWN)) dir = DOWN;
	if (UsbKeyIsPressed(HID_KEY_ARROW_LEFT)) dir = LEFT;
	if (UsbKeyIsPressed(HID_KEY_ARROW_RIGHT)) dir = RIGHT;
...
void FireMushroom()
{
	...
	Bool shoot = UsbKeyIsPressed(HID_KEY_SPACE);
